...
" --primary works, so mirror yanks through it.  This follows Vim's documented
" external-provider fallback: https://vimhelp.org/wayland.txt.html#wayland-primary-selection
