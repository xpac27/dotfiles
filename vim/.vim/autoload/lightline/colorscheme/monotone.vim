...
let s:bg3   = [ '#2a2a2a', 235 ] " inactive bg
...
let s:p.normal.left   = [ [ s:bg1, s:mode_normal ], [ s:fg2, s:bg3 ] ]
let s:p.normal.right  = [ [ s:fg1, s:dim0 ], [ s:fg2, s:dim2 ], [ s:fg2, s:bg3 ] ]
let s:p.normal.middle = [ [ s:fg2, s:bg3 ] ]

let s:p.insert.left   = [ [ s:bg1, s:mode_insert ], [ s:fg2, s:bg3 ] ]
let s:p.visual.left   = [ [ s:bg1, s:mode_visual ], [ s:fg2, s:bg3 ] ]
let s:p.replace.left  = [ [ s:bg1, s:mode_replace ], [ s:fg2, s:bg3 ] ]
