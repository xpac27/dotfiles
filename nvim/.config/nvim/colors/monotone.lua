...
hi('qfTestName', { fg = p.fg0 })
hi('qfTiming', { fg = p.dim0 })
hi('TestFailed', { link = 'ErrorMsg' })
hi('GTestOk', { link = 'Success' })
hi('GTestPassed', { link = 'Success' })
hi('GTestFailed', { link = 'ErrorMsg' })
hi('GTestError', { link = 'ErrorMsg' })
hi('GTestNote', { link = 'WarningMsg' })
hi('ITestError', { link = 'Error' })
hi('ITestWarning', { link = 'Warning' })
hi('ITestSuccess', { link = 'Success' })
