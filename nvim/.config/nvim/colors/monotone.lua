...
hi('QfExplainBorderBlend', { fg = p.hint_bg, bg = p.hint_bg })
hi('QfExplainBorderSide', { fg = p.hint, bg = p.hint_bg })
hi('QfExplainMarkerPending', { fg = p.warn_msg_fg, bg = 'NONE', italic = true })
hi('QfExplainMarkerReady', { fg = p.fg0, bg = 'NONE' })
hi('QfExplainMarkerError', { fg = p.err_msg_fg, bg = 'NONE', italic = true })
...
hi('ClangError', { link = 'ErrorMsg' })
hi('ClangWarning', { link = 'WarningMsg' })
hi('ClangNote', { link = 'InfoMsg' })
...
hi('RenderMarkdownH1', { fg = p.err, bold = true })
hi('RenderMarkdownH2', { fg = p.warn, bold = true })
hi('RenderMarkdownH3', { fg = p.info, bold = true })
hi('RenderMarkdownH4', { fg = p.hint, bold = true })
hi('RenderMarkdownH5', { fg = p.fg0, bold = true })
hi('RenderMarkdownH6', { fg = p.fg1, bold = true })
hi('RenderMarkdownH1Bg', { bg = p.err_msg_bg })
hi('RenderMarkdownH2Bg', { bg = p.warn_msg_bg })
hi('RenderMarkdownH3Bg', { bg = p.info_bg })
hi('RenderMarkdownH4Bg', { bg = p.hint_bg })
hi('RenderMarkdownH5Bg', { bg = p.bg2 })
hi('RenderMarkdownH6Bg', { bg = p.bg1 })
hi('RenderMarkdownCode', { fg = p.hint })
hi('RenderMarkdownCodeInline', { fg = p.hint })
...
hi('@markup.raw.block.markdown', { fg = p.hint })
hi('@markup.raw.markdown_inline', { fg = p.hint })
hi('markdownCode', { fg = p.hint })
hi('markdownCodeBlock', { fg = p.hint })
