...
hi('qfError', { fg = p.err_msg_fg, bg = 'NONE' })
...
hi('GTestError', { fg = p.err_msg_fg, italic = true })
hi('GTestNote', { fg = p.warn_msg_fg, italic = true })
hi('ITestError', { fg = p.err_msg_fg, bold = true })
hi('ITestWarning', { fg = p.warn, bold = true })
hi('ITestSuccess', { fg = p.ok, bold = true })
hi('ClangError', { fg = p.err_msg_fg, italic = true })
hi('ClangWarning', { fg = p.warn_msg_fg, italic = true })
hi('ClangNote', { fg = p.info, italic = true })
hi('ClangCodeLine', { fg = p.fg1 })
hi('ClangPointerLine', { fg = p.warn })
hi('ClangSummaryError', { fg = p.err_msg_fg, bold = true })
hi('ClangSummaryWarning', { fg = p.warn, bold = true })
hi('NinjaBuildStep', { fg = p.dim0 })
hi('NinjaFailure', { fg = p.err_msg_fg, bold = true })
hi('NinjaInfo', { fg = p.dim0 })
hi('NinjaStopped', { fg = p.err_msg_fg })
hi('MSBuildError', { fg = p.err_msg_fg, italic = true })
hi('MSBuildWarning', { fg = p.warn_msg_fg, italic = true })
hi('MSBuildInfo', { fg = p.info, italic = true })
hi('MSBuildNote', { fg = p.hint, italic = true })
...
-- Render-markdown gets explicit monotone styling so headings, tables, callouts,
-- and code blocks feel integrated with the rest of the editor rather than
-- falling back to unrelated defaults.
hi('RenderMarkdownH1', { fg = p.fg0, bg = p.bg4, bold = true })
hi('RenderMarkdownH2', { fg = p.fg0, bg = p.bg3, bold = true })
hi('RenderMarkdownH3', { fg = p.fg1, bg = p.bg2, bold = true })
hi('RenderMarkdownH4', { fg = p.fg1, bg = p.bg1, bold = true })
hi('RenderMarkdownH5', { fg = p.fg2, bg = p.bg1, bold = true })
hi('RenderMarkdownH6', { fg = p.dim0, bg = p.bg1, bold = true })
hi('RenderMarkdownH1Bg', { bg = p.bg4 })
hi('RenderMarkdownH2Bg', { bg = p.bg3 })
hi('RenderMarkdownH3Bg', { bg = p.bg2 })
hi('RenderMarkdownH4Bg', { bg = p.bg1 })
hi('RenderMarkdownH5Bg', { bg = p.bg1 })
hi('RenderMarkdownH6Bg', { bg = p.bg1 })
hi('RenderMarkdownCode', { fg = p.fg2, bg = 'NONE', italic = true })
hi('RenderMarkdownCodeInline', { fg = p.fg2, bg = 'NONE', italic = true })
hi('RenderMarkdownBullet', { fg = p.dim0 })
hi('RenderMarkdownQuote', { fg = p.warn })
hi('RenderMarkdownDash', { fg = p.dim1 })
hi('RenderMarkdownLink', { fg = p.info, underline = true })
hi('RenderMarkdownSign', { bg = p.bg0 })
hi('RenderMarkdownMath', { fg = p.info })
hi('RenderMarkdownUnchecked', { fg = p.dim0 })
hi('RenderMarkdownChecked', { fg = p.ok, bold = true })
hi('RenderMarkdownTodo', { fg = p.warn, bold = true })
hi('RenderMarkdownTableHead', { fg = p.fg0, bg = p.bg1, bold = true })
hi('RenderMarkdownTableRow', { fg = p.fg1, bg = p.bg0 })
hi('RenderMarkdownTableFill', { fg = p.bg2, bg = p.bg0 })
hi('RenderMarkdownSuccess', { fg = p.ok, bg = p.ok_bg, bold = true })
hi('RenderMarkdownInfo', { fg = p.info, bg = p.info_bg, bold = true })
hi('RenderMarkdownHint', { fg = p.hint, bg = p.hint_bg, bold = true })
hi('RenderMarkdownWarn', { fg = p.warn, bg = p.warn_msg_bg, bold = true })
hi('RenderMarkdownError', { fg = p.err, bg = p.err_msg_bg, bold = true })
hi('@markup.raw.block.markdown', { fg = p.fg2, bg = 'NONE', italic = true })
hi('@markup.raw.markdown_inline', { fg = p.fg2, bg = 'NONE', italic = true })
hi('markdownCode', { fg = p.fg2, bg = 'NONE', italic = true })
hi('markdownCodeBlock', { fg = p.fg2, bg = 'NONE', italic = true })
hi('markdownCodeDelimiter', { fg = p.dim0 })
hi('AgenticTitle', { fg = p.bg0, bg = p.warn, bold = true })
hi('AgenticNormal', { fg = p.fg0, bg = p.bg1 })
hi('AgenticEndOfBuffer', { fg = p.bg1, bg = p.bg1 })
hi('AgenticStatusPending', { fg = p.hint, bg = p.hint_bg, bold = true })
hi('AgenticStatusCompleted', { fg = p.ok, bg = p.ok_bg, bold = true })
hi('AgenticStatusFailed', { fg = p.err, bg = p.err_msg_bg, bold = true })
hi('AgenticCodeBlockFence', { fg = p.dim0 })
hi('AgenticSpinnerGenerating', { fg = p.info, bold = true })
hi('AgenticSpinnerThinking', { fg = p.hint, bold = true })
hi('AgenticSpinnerSearching', { fg = p.warn, bold = true })
hi('AgenticSpinnerBusy', { fg = p.dim0, italic = true })
hi('AgenticDiffAdd', { link = 'DiffAdd' })
hi('AgenticDiffDelete', { link = 'DiffDelete' })
hi('AgenticDiffAddWord', { fg = '#b7e3a1', bg = '#1a2a1a', bold = true })
hi('AgenticDiffDeleteWord', { fg = '#ffb3b3', bg = '#2a1a1a', bold = true })
...
hi('AlphaSectionTitle', { fg = p.fg1, bold = true })
