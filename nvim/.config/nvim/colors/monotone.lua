...
hi('RenderMarkdownCode', { fg = p.warn, bg = p.bg1 })
hi('RenderMarkdownCodeInline', { fg = p.warn, bg = p.bg2 })
...
hi('@markup.raw.block.markdown', { fg = p.warn, bg = p.bg1 })
hi('@markup.raw.markdown_inline', { fg = p.warn })
hi('markdownCode', { fg = p.warn, bg = p.bg2 })
hi('markdownCodeBlock', { fg = p.warn, bg = p.bg1 })
